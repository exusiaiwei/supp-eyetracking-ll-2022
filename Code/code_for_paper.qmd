...
ggplot(data, aes(x = Time)) +
    geom_line(aes(y = Text, color = "Text"), linewidth = 0.8) +
    geom_line(aes(y = Image, color = "Image"), linewidth = 0.8) +
...
ggplot(data, aes(x = Time)) +
    geom_line(aes(y = Text, color = "Text"), linewidth = 0.8) +
    geom_line(aes(y = Image, color = "Image"), linewidth = 0.8) +
    labs(title = "Proportion of Fixations Over Time", x = "Time (milliseconds)", y = "Proportion of Fixations", color = "Variable") +
    scale_color_brewer(palette = "Set2") +
    theme_minimal(base_size = 16) +
    theme(
        panel.background = element_rect(fill = "white"),
